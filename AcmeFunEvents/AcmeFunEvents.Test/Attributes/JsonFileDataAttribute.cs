...
namespace AcmeFunEvents.Test.Attributes
{
    /// <summary>
    /// Usage example https://andrewlock.net/creating-a-custom-xunit-theory-test-dataattribute-to-load-data-from-json-files
    /// </summary>
